    ...
    <article className="group">
      <div className="relative overflow-hidden bg-secondary">
        ...
        <div className="absolute left-3 top-3 flex flex-col gap-2">
          {discount > 0 && (
            <span className="bg-gold px-2.5 py-1 text-[10px] uppercase tracking-[0.2em] text-primary-foreground">
              -{discount}%
            </span>
          )}
        ...
        <div className="absolute right-3 top-3 flex flex-col gap-2">
          <button
            ...
            className="grid size-9 place-items-center rounded-full bg-background/90 backdrop-blur hover:text-gold"
          >
            <Heart
              className="size-4"
      ...
      <div className="pt-4">
        ...
        <DialogContent className="max-w-5xl overflow-hidden rounded-none p-0">
